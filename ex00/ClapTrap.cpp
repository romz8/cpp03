...
/*   Updated: 2024/01/22 21:27:36 by rjobert          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target)
{
	...
	{
		std::cout << this->_Name << "\33[41m Can't do anything, no more Energy or Hit points\33[0m";
		std::cout << std::endl;
		return ;
	}
	...
	this->_EnergyPoints--;
	if (!_EnergyPoints)
		std::cout << "\33[31mClapTrap " << this->_Name << " Died after running out of Energy Points\33[0m" << std::endl;
}
